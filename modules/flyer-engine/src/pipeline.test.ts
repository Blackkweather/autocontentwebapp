...
vi.mock("./copy", () => ({ generateEventCopy: vi.fn() }));
vi.mock("./poster/render", () => ({ renderPoster: vi.fn() }));
vi.mock("@club-os/core/observability/errorTracking", () => ({ captureGenerationFailure: vi.fn() }));
...
import { generateEventCopy } from "./copy";
import { renderPoster } from "./poster/render";
import { captureGenerationFailure } from "@club-os/core/observability/errorTracking";
