// Amaze Live poster copy generation — brand voice and prompt-engineering specific to the flyer
// pipeline, built on top of @club-os/core's generic Groq chat client.

import { groqChatJSON, GROQ_MODELS } from "@club-os/core/ai/groq";
